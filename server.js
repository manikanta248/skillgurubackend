...
app.get('/generate-token', (req, res) => {
  return res.json({ "007eJxTYDiYnfAqNsht6+9phgumWWhYPV1pLFIX9+SNZpf+FAnzyk4FhjTjZKMUs1QjixTzRJPk5JSkFAMT81QTQwsTo1RLszSzDfUu6Q2BjAwfnKsYGRkgEMRnZ0jLKS0pSS1iYAAApZkgog==" });
